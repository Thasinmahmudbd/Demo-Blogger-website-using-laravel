    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="{{url('/')}}">Thasin's Blog</a>
        ...
        <!-- Page Header-->
        <header class="masthead" style="background-image: url('{{ asset('user_assets/assets/img/home-bg.jpg') }}')">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <h1>@yield('page_name')</h1>
                            <span class="subheading">@yield('date')</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="small text-center text-muted fst-italic">Copyright &copy; Thasin's Blog 2021</div>
                    </div>
                </div>
            </div>
        </footer>
